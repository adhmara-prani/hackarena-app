...
const UnifiedLearningCopilot = () => {
  const [messages, setMessages] = useState([
    {
      id: 1,
      text: "Hi! I'm your learning copilot. Upload a file or describe what you're studying, and I'll help make it easier to understand!",
      isUser: false,
      timestamp: new Date(),
    },
  ]);
    ...
    switch (action) {
      ...
      case "explain":
        response = {
          ...
          isUser: false,
          content:
            "Neuroplasticity is like your brain's superpower. It allows your brain to reorganize itself by forming new connections between neurons. This means your brain isn't fixed - it can change and adapt throughout your life!",
              ...
              <div className="space-y-3">
                {activeFeature && (
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    <h3 className="font-medium text-blue-800 mb-1 capitalize">
                      {activeFeature} Mode
                    </h3>
                      ...
                      {message.contentType === "simplified" && (
                        <div className="mt-4 p-4 bg-blue-50 rounded-lg border border-blue-200">
                          ...
                          <button className="mt-3 flex items-center text-blue-600">
                            <FiHeadphones className="mr-1" /> Play Audio
                            Narration
                          </button>
                        </div>
                      )}
